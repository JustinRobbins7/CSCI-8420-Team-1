...
- __Observation:__ As discussed in _Mitigation 21_, Liberapay does indeed secure communication and encrypt data flow. But it does not have appear to have any protections in place that prevent a denial of service attack, therefore that poses a risk.
